<?php
  ...
  $gallerypagelimit = 3;
  $page = 1;
  $photocount = countPrivatePhotos(2);
  ...
  $privatephotothumbshtml = readPrivatePhotoThumbsPage(2, $gallerypagelimit, $page);
...
?>
  ...
  <!--sulgemisnupp-->
  <div class="modalclose" class="modalclose">&times;</span>
