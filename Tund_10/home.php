<?php
  ...
  setcookie("vpvisitorname", $_SESSION["userfirstname"] ." " .$_SESSION["userlastname"], time() + (86400 * 8), "/~gasplui/", "greeny.cs.tlu.ee", isset($_SERVER["HTTPS"]), true);
  $lastvisitor = null;
...
?>
  ...
  <ul>
    <li><a href="insertideas.php">Lisa oma mõte</a></li>
	...
	<li><a href="photogallery_public.php">Avalik fotogalerii</a>
	<li><a href="photogallery_private.php">Privaatne fotogalerii</li>
  </ul>
